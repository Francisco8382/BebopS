...
namespace bebop_simulator {
    ...
    class Launcher{
        ...
        private:
            double K1_xy_i, K1_z_i, K1_phi_theta_i, K1_psi_i;
            double K2_xy_i, K2_z_i, K2_phi_theta_i, K2_psi_i;
            double K34_xy_i, K34_z_i, K34_phi_theta_i, K34_psi_i;
            double K1_xy_f, K1_z_f, K1_phi_theta_f, K1_psi_f;
            double K2_xy_f, K2_z_f, K2_phi_theta_f, K2_psi_f;
            double K34_xy_f, K34_z_f, K34_phi_theta_f, K34_psi_f;
            double K1_xy_d, K1_z_d, K1_phi_theta_d, K1_psi_d;
            double K2_xy_d, K2_z_d, K2_phi_theta_d, K2_psi_d;
            double K34_xy_d, K34_z_d, K34_phi_theta_d, K34_psi_d;
            double K1_xy, K1_z, K1_phi_theta, K1_psi;
            double K2_xy, K2_z, K2_phi_theta, K2_psi;
            double K34_xy, K34_z, K34_phi_theta, K34_psi;
            double sigma;
            std::string pos_controller_node, csv_odometry, plot, waypoint, control;
    ...
    void Launcher::InitializeParams() {
      ...
      bool verbose;
      ros::param::get("~K1_xy/K1_xy_i", K1_xy_i);
      ros::param::get("~K1_z/K1_z_i", K1_z_i);
      ros::param::get("~K1_phi_theta/K1_phi_theta_i", K1_phi_theta_i);
      ros::param::get("~K1_psi/K1_psi_i", K1_psi_i);
      ros::param::get("~K2_xy/K2_xy_i", K2_xy_i);
      ros::param::get("~K2_z/K2_z_i", K2_z_i);
      ros::param::get("~K2_phi_theta/K2_phi_theta_i", K2_phi_theta_i);
      ros::param::get("~K2_psi/K2_psi_i", K2_psi_i);
      ros::param::get("~K34_xy/K34_xy_i", K34_xy_i);
      ros::param::get("~K34_z/K34_z_i", K34_z_i);
      ros::param::get("~K34_phi_theta/K34_phi_theta_i", K34_phi_theta_i);
      ros::param::get("~K34_psi/K34_psi_i", K34_psi_i);
      ros::param::get("~K1_xy/K1_xy_f", K1_xy_f);
      ros::param::get("~K1_z/K1_z_f", K1_z_f);
      ros::param::get("~K1_phi_theta/K1_phi_theta_f", K1_phi_theta_f);
      ros::param::get("~K1_psi/K1_psi_f", K1_psi_f);
      ros::param::get("~K2_xy/K2_xy_f", K2_xy_f);
      ros::param::get("~K2_z/K2_z_f", K2_z_f);
      ros::param::get("~K2_phi_theta/K2_phi_theta_f", K2_phi_theta_f);
      ros::param::get("~K2_psi/K2_psi_f", K2_psi_f);
      ros::param::get("~K34_xy/K34_xy_f", K34_xy_f);
      ros::param::get("~K34_z/K34_z_f", K34_z_f);
      ros::param::get("~K34_phi_theta/K34_phi_theta_f", K34_phi_theta_f);
      ros::param::get("~K34_psi/K34_psi_f", K34_psi_f);
      ros::param::get("~K1_xy/K1_xy_d", K1_xy_d);
      ros::param::get("~K1_z/K1_z_d", K1_z_d);
      ros::param::get("~K1_phi_theta/K1_phi_theta_d", K1_phi_theta_d);
      ros::param::get("~K1_psi/K1_psi_d", K1_psi_d);
      ros::param::get("~K2_xy/K2_xy_d", K2_xy_d);
      ros::param::get("~K2_z/K2_z_d", K2_z_d);
      ros::param::get("~K2_phi_theta/K2_phi_theta_d", K2_phi_theta_d);
      ros::param::get("~K2_psi/K2_psi_d", K2_psi_d);
      ros::param::get("~K34_xy/K34_xy_d", K34_xy_d);
      ros::param::get("~K34_z/K34_z_d", K34_z_d);
      ros::param::get("~K34_phi_theta/K34_phi_theta_d", K34_phi_theta_d);
      ros::param::get("~K34_psi/K34_psi_d", K34_psi_d);
      ros::param::get("~sigma/sigma", sigma);
      ...
      pos_controller_node = "rosrun bebop_simulator pos_controller_node_3 _U_xyz/U_x:=" 
      ...
      plot = "rosrun bebop_simulator plot_3.py _Ruta:=" + Ruta
      ...
      control = "rosrun bebop_simulator csv_control _Ruta:="
      + Ruta + " _TiempoMargen:=" + s_TiempoMargen
      + " _Topico:=/Control"
      + " _Nombre:=Control.csv";
      ...
      K1_xy = K1_xy_i;
      K1_z = K1_z_i;
      K1_phi_theta = K1_phi_theta_i;
      K1_psi = K1_psi_i;
      K2_xy = K2_xy_i;
      K2_z = K2_z_i;
      K2_phi_theta = K2_phi_theta_i;
      K2_psi = K2_psi_i;
      K34_xy = K34_xy_i;
      K34_z = K34_z_i;
      K34_phi_theta = K34_phi_theta_i;
      K34_psi = K34_psi_i;
    ...
    void Launcher::TimerCallback(const ros::TimerEvent& event) {
      RunNodes();
      K2_xy += K2_xy_d;
      if (K2_xy < K2_xy_f && K2_xy_d > 0){
        return;
      }
      K2_xy = K2_xy_i;
      K2_z += K2_z_d;
      if (K2_z < K2_z_f && K2_z_d > 0){
        return;
      }
      K2_z = K2_z_i;
      K2_phi_theta += K2_phi_theta_d;
      if (K2_phi_theta < K2_phi_theta_f && K2_phi_theta_d > 0){
        return;
      }
      K2_phi_theta = K2_phi_theta_i;
      K2_psi += K2_psi_d;
      if (K2_psi < K2_psi_f && K2_psi_d > 0){
        return;
      }
      K2_psi = K2_psi_i;
      K1_xy += K1_xy_d;
      ...
      if (K1_z < K1_z_f && K1_z_d > 0){
        return;
      }
      K1_z = K1_z_i;
      K1_phi_theta += K1_phi_theta_d;
      while (K1_phi_theta >= K2_phi_theta){
        K2_phi_theta += K2_phi_theta_d;
        K2_phi_theta_i = K2_phi_theta;
      }
      if (K1_phi_theta < K1_phi_theta_f && K1_phi_theta_d > 0){
        return;
      }
      K1_phi_theta = K1_phi_theta_i;
      K1_psi += K1_psi_d;
      ...
      if (K1_psi < K1_psi_f && K1_psi_d > 0){
        return;
      }
      K1_psi = K1_psi_i;
      K34_xy += K34_xy_d;
      if (K34_xy < K34_xy_f && K34_xy_d > 0){
        return;
      }
      K34_xy = K34_xy_i;
      K34_z += K34_z_d;
      if (K34_z < K34_z_f && K34_z_d > 0){
        return;
      }
      K34_z = K34_z_i;
      K34_phi_theta += K34_phi_theta_d;
      if (K34_phi_theta < K34_phi_theta_f && K34_phi_theta_d > 0){
        return;
      }
      K34_phi_theta = K34_phi_theta_i;
      K34_psi += K34_psi_d;
      if (K34_psi < K34_psi_f && K34_psi_d > 0){
        return;
      }
      else {
        ros::shutdown();
    ...
    void Launcher::RunNodes() {
      if (K2_xy <= K1_xy || K2_z <= K1_z || K2_phi_theta <= K1_phi_theta || K2_psi <= K1_psi){
        return;
      }
      std::string s_K1_xy, s_K1_z, s_K1_phi_theta, s_K1_psi,
      s_K2_xy, s_K2_z, s_K2_phi_theta, s_K2_psi,
      s_K34_xy, s_K34_z, s_K34_phi_theta, s_K34_psi,
      s_sigma, s_controller_params;
      std::string run_pos_controller_node, run_csv1, run_csv2, run_csv3, run_csv4,
      run_plot, run_waypoint, run_control;
      s_K1_xy = std::to_string(K1_xy);
      s_K1_z = std::to_string(K1_z);
      s_K1_phi_theta = std::to_string(K1_phi_theta);
      s_K1_psi = std::to_string(K1_psi);
      s_K2_xy = std::to_string(K2_xy);
      s_K2_z = std::to_string(K2_z);
      s_K2_phi_theta = std::to_string(K2_phi_theta);
      s_K2_psi = std::to_string(K2_psi);
      s_K34_xy = std::to_string(K34_xy);
      s_K34_z = std::to_string(K34_z);
      s_K34_phi_theta = std::to_string(K34_phi_theta);
      s_K34_psi = std::to_string(K34_psi);
      s_sigma = std::to_string(sigma);
      
      s_controller_params = " _K1_xy/K1_xy:=" + s_K1_xy
      + " _K1_z/K1_z:=" + s_K1_z
      + " _K1_phi_theta/K1_phi_theta:=" + s_K1_phi_theta + " _K1_psi/K1_psi:=" + s_K1_psi
      + " _K2_xy/K2_xy:=" + s_K2_xy + " _K2_z/K2_z:=" + s_K2_z 
      + " _K2_phi_theta/K2_phi_theta:=" + s_K2_phi_theta + " _K2_psi/K2_psi:=" + s_K2_psi
      + " _K3_xy/K3_xy:=" + s_K34_xy + " _K3_z/K3_z:=" + s_K34_z 
      + " _K3_phi_theta/K3_phi_theta:=" + s_K34_phi_theta + " _K3_psi/K3_psi:=" + s_K34_psi
      + " _K4_xy/K4_xy:=" + s_K34_xy + " _K4_z/K4_z:=" + s_K34_z 
      + " _K4_phi_theta/K4_phi_theta:=" + s_K34_phi_theta + " _K4_psi/K4_psi:=" + s_K34_psi
      + " _sigma/sigma:=" + s_sigma;
      ...
      run_control = control + " __name:=csv_control";
      ...
      std::thread th_control(system,run_control.c_str());
