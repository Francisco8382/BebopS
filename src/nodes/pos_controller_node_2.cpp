...
#include "pos_controller_node_2.h"
...
void PositionControllerNode::InitializeParams() {
  ...
  GetRosParameter(pnh, "Kp_xy/Kp_xy",
                  position_controller_.controller_parameters_.Kp_xy_,
                  &position_controller_.controller_parameters_.Kp_xy_);
  GetRosParameter(pnh, "Kp_z/Kp_z",
                  position_controller_.controller_parameters_.Kp_z_,
                  &position_controller_.controller_parameters_.Kp_z_);
  
  GetRosParameter(pnh, "Kp_phi_theta/Kp_phi_theta",
                  position_controller_.controller_parameters_.Kp_phi_theta_,
                  &position_controller_.controller_parameters_.Kp_phi_theta_);
  GetRosParameter(pnh, "Kp_psi/Kp_psi",
                  position_controller_.controller_parameters_.Kp_psi_,
                  &position_controller_.controller_parameters_.Kp_psi_);

  GetRosParameter(pnh, "Td_xy/Td_xy",
                  position_controller_.controller_parameters_.Td_xy_,
                  &position_controller_.controller_parameters_.Td_xy_);
  GetRosParameter(pnh, "Td_z/Td_z",
                  position_controller_.controller_parameters_.Td_z_,
                  &position_controller_.controller_parameters_.Td_z_);
  
  GetRosParameter(pnh, "Td_phi_theta/Td_phi_theta",
                  position_controller_.controller_parameters_.Td_phi_theta_,
                  &position_controller_.controller_parameters_.Td_phi_theta_);
  GetRosParameter(pnh, "Td_psi/Td_psi",
                  position_controller_.controller_parameters_.Td_psi_,
                  &position_controller_.controller_parameters_.Td_psi_);

  GetRosParameter(pnh, "Ti_xy/Ti_xy",
                  position_controller_.controller_parameters_.Ti_xy_,
                  &position_controller_.controller_parameters_.Ti_xy_);
  GetRosParameter(pnh, "Ti_z/Ti_z",
                  position_controller_.controller_parameters_.Ti_z_,
                  &position_controller_.controller_parameters_.Ti_z_);
  
  GetRosParameter(pnh, "Ti_phi_theta/Ti_phi_theta",
                  position_controller_.controller_parameters_.Ti_phi_theta_,
                  &position_controller_.controller_parameters_.Ti_phi_theta_);
  GetRosParameter(pnh, "Ti_psi/Ti_psi",
                  position_controller_.controller_parameters_.Ti_psi_,
                  &position_controller_.controller_parameters_.Ti_psi_);
