...
// Archivo basado en position_controller_node.cpp

#include <ros/ros.h>
#include <mav_msgs/default_topics.h>
#include <ros/console.h> 

#include "pos_controller_node_3.h"
...
PositionControllerNode::PositionControllerNode() {
    ...
    End_ = nh.subscribe<std_msgs::Empty>("/restart", 1, &PositionControllerNode::StopCallback, this);
...
void PositionControllerNode::StopCallback(const std_msgs::Empty::ConstPtr& empty_msg) {
      ROS_INFO("Reiniciando mundo");
      Eigen::Vector4d ref_rotor_velocities(0.0,0.0,0.0,0.0);
...
void PositionControllerNode::InitializeParams() {
  ...
  GetRosParameter(pnh, "K1_xy/K1_xy",
                  position_controller_.controller_parameters_.K1_xy_,
                  &position_controller_.controller_parameters_.K1_xy_);
  GetRosParameter(pnh, "K1_z/K1_z",
                  position_controller_.controller_parameters_.K1_z_,
                  &position_controller_.controller_parameters_.K1_z_);
  
  GetRosParameter(pnh, "K1_phi_theta/K1_phi_theta",
                  position_controller_.controller_parameters_.K1_phi_theta_,
                  &position_controller_.controller_parameters_.K1_phi_theta_);
  GetRosParameter(pnh, "K1_psi/K1_psi",
                  position_controller_.controller_parameters_.K1_psi_,
                  &position_controller_.controller_parameters_.K1_psi_);

  GetRosParameter(pnh, "K2_xy/K2_xy",
                  position_controller_.controller_parameters_.K2_xy_,
                  &position_controller_.controller_parameters_.K2_xy_);
  GetRosParameter(pnh, "K2_z/K2_z",
                  position_controller_.controller_parameters_.K2_z_,
                  &position_controller_.controller_parameters_.K2_z_);
  
  GetRosParameter(pnh, "K2_phi_theta/K2_phi_theta",
                  position_controller_.controller_parameters_.K2_phi_theta_,
                  &position_controller_.controller_parameters_.K2_phi_theta_);
  GetRosParameter(pnh, "K2_psi/K2_psi",
                  position_controller_.controller_parameters_.K2_psi_,
                  &position_controller_.controller_parameters_.K2_psi_);

  GetRosParameter(pnh, "K3_xy/K3_xy",
                  position_controller_.controller_parameters_.K3_xy_,
                  &position_controller_.controller_parameters_.K3_xy_);
  GetRosParameter(pnh, "K3_z/K3_z",
                  position_controller_.controller_parameters_.K3_z_,
                  &position_controller_.controller_parameters_.K3_z_);
  
  GetRosParameter(pnh, "K3_phi_theta/K3_phi_theta",
                  position_controller_.controller_parameters_.K3_phi_theta_,
                  &position_controller_.controller_parameters_.K3_phi_theta_);
  GetRosParameter(pnh, "K3_psi/K3_psi",
                  position_controller_.controller_parameters_.K3_psi_,
                  &position_controller_.controller_parameters_.K3_psi_);

  GetRosParameter(pnh, "K4_xy/K4_xy",
                  position_controller_.controller_parameters_.K4_xy_,
                  &position_controller_.controller_parameters_.K4_xy_);
  GetRosParameter(pnh, "K4_z/K4_z",
                  position_controller_.controller_parameters_.K4_z_,
                  &position_controller_.controller_parameters_.K4_z_);
  
  GetRosParameter(pnh, "K4_phi_theta/K4_phi_theta",
                  position_controller_.controller_parameters_.K4_phi_theta_,
                  &position_controller_.controller_parameters_.K4_phi_theta_);
  GetRosParameter(pnh, "K4_psi/K4_psi",
                  position_controller_.controller_parameters_.K4_psi_,
                  &position_controller_.controller_parameters_.K4_psi_);

  GetRosParameter(pnh, "sigma/sigma",
                  position_controller_.controller_parameters_.sigma_,
                  &position_controller_.controller_parameters_.sigma_);
